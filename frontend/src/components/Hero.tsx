      ...
      <div className="flex justify-center items-center mt-2 bg-gray-200 rounded-2xl shadow-sm  px-16">
        <div className=" w-1/2 flex flex-col items-start justify-start space-y-3">
          <div className="leading-10">
            <span className="  text-2xl sm:text-7xl   uppercase font-semibold before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-white relative inline-block  ">
              <span className="relative  ">let's</span>
            </span>
            <br></br>{" "}
            <span className="  text-2xl sm:text-7xl  uppercase font-semibold ">
              explore
            </span>{" "}
            <br></br>{" "}
            <span className=" text-2xl sm:text-7xl   uppercase font-semibold before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-yellow-400 relative inline-block ">
